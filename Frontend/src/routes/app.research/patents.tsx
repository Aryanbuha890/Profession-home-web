  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in duration-500 p-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white">Patents</h1>
          <p className="text-sm text-slate-400 mt-1">Manage patents settings and view data.</p>
        </div>
