...
export const Route = createFileRoute("/app/student/achievements")({
  ...
  return (
    <div className="min-h-screen bg-[#05060F] text-slate-100 p-6 md:p-8 space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 pb-6">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-white font-display">Leaderboard</h1>
          <p className="text-slate-400 text-sm mt-1">Track challenges, match stats, and claim ultimate bragging rights.</p>
        </div>
