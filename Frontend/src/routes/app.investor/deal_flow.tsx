...
export const Route = createFileRoute("/app/investor/deal_flow")({
    ...
    <div className="space-y-6 animate-in fade-in zoom-in duration-500 p-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Manage deal flow settings and view data.</p>
        </div>
