...
export const Route = createFileRoute("/app/startup/assessment")({
  component: StartupAssessmentWrapper,
});
...
function StartupAssessment({ onSaveAssessment, savedResult }: StartupAssessmentProps) {
  // Assessment state
        ...
        {!showResults ? (
          ...
          >
            ...
            <div className="py-4 space-y-3">
              <div className="inline-flex items-center gap-1.5 bg-indigo-500/10 text-indigo-400 py-1.5 px-3 rounded-full text-[11px] font-mono leading-none capitalize">
            ...
            {/* Nav Row */}
            <div className="flex justify-between items-center pt-4 border-t border-[#1F2947]/80">
              <button
                id="assess-back-btn"
                onClick={handleBack}
          ...
          >
            ...
            {/* Radar Visualizer */}
            <div className="lg:col-span-6 bg-[#0F1528] border border-[#1F2947] p-6 rounded-3xl flex flex-col justify-between shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-display font-bold text-slate-200">Execution Vector Radar</h4>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs border-t border-[#1F2947]/80 pt-4 bg-[#0B0F19]/40 p-4 rounded-2xl">
            ...
            <div className="lg:col-span-6 bg-[#0F1528] border border-[#1F2947] p-6 rounded-3xl shadow-sm space-y-6">
              ...
              <div className="flex gap-3 bg-indigo-500/15 border border-indigo-500/30 p-4 rounded-2xl">
                <ShieldCheck className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <h5 className="text-xs font-semibold text-indigo-300">Continuous Assessment Logic</h5>
                  <p className="text-[11px] text-indigo-400 leading-relaxed font-sans">
            ...
            <div className="lg:col-span-12 bg-[#0F1528] border border-[#1F2947] p-6 rounded-3xl shadow-sm space-y-6">
              <div>
                <h4 className="text-lg font-display font-extrabold text-white mb-2">Startup Diagnosis</h4>
                <p className="text-sm text-slate-400 leading-relaxed">{savedResult.diagnosis}</p>
              </div>
                  ...
                  {savedResult.recommendations.map((reco, idx) => (
                    <div key={idx} className="bg-[#0B0F19]/50 p-4 rounded-2xl border border-[#1F2947]/80 flex flex-col justify-between space-y-3">
                      <div className="space-y-1.5">
                        ...
                        <p className="text-xs text-slate-300 leading-relaxed">{reco}</p>
                      </div>
