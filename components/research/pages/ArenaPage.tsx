                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  {activeModule.id === "lit" && "papers" in activeModule.content && (
                    <SpotlightCard className="p-5">
                      ...
                      <div className="grid grid-cols-4 gap-2 mb-4">
                        {Object.entries((activeModule.content as any).prismaStats || {}).map(([k, v]) => (
                          <div key={k} className="text-center p-2 rounded-lg bg-white/5 border border-white/10">
                            <div className="text-lg font-black text-violet-400">{v as any}</div>
                            <div className="text-[8px] font-mono text-muted-foreground uppercase">{k}</div>
                          </div>
                        ))}
                      </div>
                      <div className="space-y-2">
                        {((activeModule.content as any).papers || []).map((p: any, i: number) => (
                          <motion.div
                            key={p.title}
                  ...
                  {activeModule.id === "abstract" && "draft" in activeModule.content && (
                    <SpotlightCard className="p-5">
                      ...
                      {Object.entries((activeModule.content as any).draft || {}).map(([section, text]) => (
                      ...
                      <div className="mt-3 flex flex-wrap gap-1.5">
                        {((activeModule.content as any).keywords || []).map((k: any) => (
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-2">
                        {Object.entries((activeModule.content as any).aiScore || {}).map(([k, v]) => (
                          <div key={k} className="text-center p-2 rounded-lg bg-white/5">
                            <div className="text-sm font-black text-violet-400">{v as any}</div>
                            <div className="text-[8px] font-mono text-muted-foreground uppercase">{k}</div>
                          </div>
                        ))}
                      </div>
                  ...
                  {activeModule.id === "review" && "sections" in activeModule.content && (
                    <SpotlightCard className="p-5">
                      ...
                      <p className="text-[10px] text-muted-foreground mb-3">
                        Target: {(activeModule.content as any).targetJournal} · Co-authors: {((activeModule.content as any).coAuthors || []).join(", ")}
                      </p>
                      <div className="space-y-2">
                        {((activeModule.content as any).sections || []).map((s: any) => (
                          <div
                            key={s.name}
                  ...
                  {activeModule.id === "analytics" && "stats" in activeModule.content && (
                    <SpotlightCard className="p-5">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        {((activeModule.content as any).stats || []).map((s: any) => (
                      ...
                      <div className="space-y-1">
                        {((activeModule.content as any).charts || []).map((c: any) => (
