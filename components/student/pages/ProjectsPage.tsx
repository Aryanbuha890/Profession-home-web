...
function ProjectsPage() {
  ...
  return (
    <Page title="Projects" subtitle="Manage your portfolio and active deliverables.">
      <PageHero
        badge="Student Workspace"
        title="Projects"
        subtitle="Track active assignments, build templates, and manage your completions."
        accent="#38bdf8"
      >
        <div className="flex flex-col md:flex-row md:items-center gap-4 mt-4 md:mt-0">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-500 to-indigo-500 text-slate-950 hover:scale-[1.02] shadow-lg text-xs font-bold rounded-xl transition duration-200 cursor-pointer"
          >
