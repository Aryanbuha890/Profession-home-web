  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-6xl px-6 flex flex-col justify-center items-center flex-1 z-10">
        <motion.div
          style={{ y }}
          className="mx-auto max-w-5xl text-center w-full flex flex-col items-center justify-center"
        >
          ...
          >
            ...
            <button suppressHydrationWarning className="inline-flex h-12 items-center gap-2 rounded-full border border-white/15 bg-white/[0.04] px-5 text-sm font-medium text-white/85 backdrop-blur-xl hover:bg-white/[0.08]">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-1 font-display text-2xl font-semibold text-white">
                      {chartValue}{" "}
                      <span className="text-xs font-medium text-emerald-300">{chartChange}</span>
                    </div>
                  </div>
...
const studentOSProps: DashboardMockupCardProps = {
  ...
  chartAreaPath:
    "M0,90 C40,82 80,68 120,52 C160,36 200,22 240,18 C280,14 320,10 400,5 L400,110 L0,110 Z",
  ...
  sparklines: [
    {
      ...
      change: "+3 target",
      color: "#8B5CF6",
      sparkPoints: [4, 6, 5, 8, 7, 9, 11, 13],
    },
    {
      label: "Diagnostic Rank",
      value: "98th",
      change: "Top 5%",
      color: "#3B82F6",
      sparkPoints: [90, 92, 91, 95, 94, 96, 97, 98],
    },
    {
      label: "Weekly Hours",
      value: "32.5h",
      change: "+4.2h",
      color: "#10B981",
      sparkPoints: [28, 30, 29, 34, 32, 31, 33, 32.5],
    },
    {
      label: "Expert Calls",
      value: "4",
  ...
  floatingChips: [
    {
      title: "Advisor Matched",
      subtitle: "McKinsey Engagement Lead",
      icon: Sparkles,
...
const researcherOSProps: DashboardMockupCardProps = {
  ...
  chartAreaPath:
    "M0,85 C40,78 80,74 120,62 C160,50 200,45 240,38 C280,30 320,20 400,10 L400,110 L0,110 Z",
  ...
  sparklines: [
    ...
    },
    {
      ...
      change: "+4 new",
      color: "#8B5CF6",
      sparkPoints: [6, 8, 8, 9, 10, 10, 11, 12],
    },
    {
  ...
  liveEvents: [
    ...
    {
      time: "15:30",
      message: "Manuscript review request: IEEE Trans",
      color: "#8B5CF6",
      tag: "review",
    },
  ],
  ...
  floatingChips: [
    {
      title: "Co-Author Found",
      subtitle: "Dr. Helena Chen (MIT)",
      icon: Users,
    ...
    {
      title: "NSF Grant Approved",
      subtitle: "$450k funding unlocked",
      icon: Award,
...
const startupOSProps: DashboardMockupCardProps = {
  ...
  sparklines: [
    ...
    },
    {
      ...
      change: "stable",
      color: "#EF4444",
      sparkPoints: [40, 42, 45, 44, 45, 45, 45, 45],
    },
    {
      label: "Net Promoter",
      value: "76",
      change: "+2 pts",
      color: "#0EA5E9",
      sparkPoints: [68, 70, 72, 70, 74, 75, 74, 76],
    },
    {
      label: "Pitch Meetings",
      value: "14",
      change: "+8 booked",
      color: "#8B5CF6",
      sparkPoints: [2, 4, 5, 8, 7, 10, 12, 14],
    },
  ],
  liveEvents: [
    {
      time: "18:02",
      message: "Investor Meeting: Sequoia Capital",
      color: "#10B981",
      tag: "meeting",
    },
    {
      time: "17:40",
      message: "Prototype validation complete: 94% score",
      color: "#3B82F6",
      tag: "milestone",
    },
    {
      time: "16:20",
      message: "Enterprise Pilot signed: Acme Corp",
      color: "#8B5CF6",
      tag: "sales",
    },
  ],
  ...
  floatingChips: [
    {
      title: "Sequoia Call Booked",
      subtitle: "Partner Pitch Scheduled",
      icon: Rocket,
      gradFrom: "from-emerald-500",
    ...
    {
      title: "$2.1M Seed Closed",
      subtitle: "Tier-1 lead VCs onboard",
      icon: Award,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-16 text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-xs sm:text-sm text-neutral-400 leading-relaxed">
            Scroll down to see the custom operating systems for Students, Researchers, and Founders
            stack seamlessly.
          </p>
        </div>
...
function PurpleCrosshair({ className, pulse = false }: { className?: string; pulse?: boolean }) {
  return (
    <div
      className={`absolute -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none z-0 ${className}`}
    >
      {/* Horizontal line */}
...
function FaintIntersection({ className }: { className?: string }) {
  return (
    <div
      className={`absolute -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none opacity-25 z-0 ${className}`}
    >
...
function ScrollRevealSection() {
  ...
  return (
    <section className="relative py-40 bg-[#05060F] flex flex-col items-center justify-center min-h-[90vh] px-6 overflow-hidden border-t border-white/5 select-none">
      ...
      <div
        ref={textRef}
        className="max-w-5xl text-center leading-[1.1] tracking-tight relative z-10 py-16 px-4"
      >
        {words.map((word, idx) => (
          <RevealWord
            key={idx}
